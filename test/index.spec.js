...
describe('Recibe, Verifica y convierte la ruta', () => {
  ...
  it('Tiene que retornar false para saber que es absoluta', () => {
    expect(funcionesMdLinks.verificateAbsolute('./lib')).toBe('C:\\Users\\Esau Ocrospoma\\Desktop\\md-links\\LIM013-fe-md-links\\lib');
  });
});

describe('Archivo o directorio, extrae .md, busca links', () => {
  it('Tiene que retornar un array con solo los archivos .md', () => expect(funcionesMdLinks.extraerMD(['C:/Users/Esau Ocrospoma/Desktop/md_links/LIM013-fe-md-links/test/archivo_prueba/archivo_prueba2/archivo_prueba3/archivo5.md'])).resolves
  ...
  it('Tiene que devolver un error .md', () => expect(funcionesMdLinks.extraerMD(['C:/Users/Esau Ocrospoma/Desktop/md-links/LIM013-fe-md-links/test/archivo_prueba/archivo_prueba2/archivo_prueba3/ultimo_archivo/ultimo_archivo_sin_extencion/sin_md-text'])).rejects
