...
console.log(exists(archivoFile));
...
// EXTRAER ARCHIVOS CON EXTENSION .MD // RETORNA ARRAY
 export const extraerMD = (archivos) => ((resolve, reject) => {
	let todoLosArchivos = [];
...
extraerMD("C:\\Users\\Esau Ocrospoma\\Desktop\\md-links\\LIM013-fe-md-links\\test\\archivo_prueba\\archivo_prueba2\\archivo_prueba3\\ultimo_archivo\\ultimo_archivo_sin_extencion\\sin_md-text", { validate : true })
